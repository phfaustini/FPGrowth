...
buildConditionalPatternBase headerTable node = map (headerTableToConditionalPatternBase node) headerTable
...
frequentPatternItems cpbs threshold = map (frequentPatternCPB threshold) cpbs
